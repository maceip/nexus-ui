...
function ClaudeArrowUp({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
function ClaudeDisc({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export { ClaudeAdd, ClaudeAudioLines, ClaudeCaret, ClaudeArrowUp, ClaudeDisc };
