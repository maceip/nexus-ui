...
/** Same as **With Prompt Input**, plus **`AttachmentsDropOverlay`** (default fullscreen) while dragging files — drops are handled on `document` by **`Attachments`**. Use **`variant="contained"`** on the overlay inside a **`relative`** shell for in-box chrome only. */
function AttachmentsWithPromptInputAndDrop() {
...
export default AttachmentsWithPromptInputAndDrop;
