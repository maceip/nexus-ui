...
export function validateContextualInput(
  ...
  const [domain, owner, repo, ...rest] = normalizedValue.replace(/\/+$/, "").split("/");
...
export function ContextualTextInput({
  ...
  return (
    ...
    >
      ...
      />
      <div className="pointer-events-none absolute top-3 right-3 flex size-8 items-center justify-center rounded-full border border-black/5 bg-white/80 text-foreground shadow-xs dark:border-white/10 dark:bg-black/30">
