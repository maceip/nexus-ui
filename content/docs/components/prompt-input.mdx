...
<TypeTable
  type={{
    onSubmit: {
      ...
      description:
        "Called when Enter is pressed in the textarea (without Shift). Use with value/onChange on PromptInputTextarea for controlled mode. Shift+Enter inserts a new line.",
    },
    className: {
      type: "string",
