...
<TypeTable
  type={{
    ...
    highlight: {
      type: "string | string[]",
      description: "Defines the text(s) or word(s) in the suggestion to be highlighted. Matches are case-insensitive. Style the highlighted text via className or by composing your own wrapper.",
    },
    value: {
      type: "string",
...
<TypeTable
  type={{
    onClose: {
      type: "() => void",
      description: "Callback fired when the panel should close (e.g. Escape key).",
    },
    className: {
      type: "string",
...
<TypeTable
  type={{
    asChild: {
      type: "boolean",
      default: "false",
      description: "Merges props onto the child element instead of rendering a div.",
    },
    className: {
      type: "string",
